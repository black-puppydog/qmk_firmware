...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
  KC_TILD,         KC_1,    KC_2,     KC_3,     KC_4,   KC_5,    KC_LPRN,                          KC_RPRN,  KC_6,     KC_7,    KC_8,     KC_9,     KC_0,     KC_DEL,
  KC_TAB,          KC_Q,    KC_W,     KC_E,     KC_R,   KC_T,    KC_LBRC,                          KC_RBRC,  KC_Y,     KC_U,     KC_I,     KC_O,    KC_P,     KC_BSLS,     \
  KC_BSPC,         KC_A,    KC_S,     KC_D,     KC_F,   KC_G,    KC_LCBR,                          KC_RCBR,  KC_H,     KC_J,     KC_K,     KC_L,    KC_SCLN,  KC_QUOT,    \
  LSFT_T(KC_ESC),  KC_Z,    KC_X,     KC_C,     KC_V,   KC_B,    KC_SPC,                           KC_SPC,   KC_N,     KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,  KC_SFTENT,  \
                                 KC_LGUI,  LCTL_T(KC_ESC),  KC_LALT,  LOWER,                    RAISE,    KC_RALT,  KC_APP,  ADJUST        \
  //,---------------------------------------------------------------------.  ,---------------------------------------------------------------------.
